...
export default function HeroBackground() {
    return (
        <div className='absolute overflow-hidden inset-0 w-full h-[1024px] pointer-events-none'>
            {/* noise */}
            <Image src={"/noise.png"} alt="noise" width={1920} height={1080} className='w-full h-full object-cover pointer-events-none opacity-5' />
            {/* left abstract */}
